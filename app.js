...
exports.test = async () => {
	try {
		...
		try {
			...
			console.log('\n--> Submit Transaction: Mint, creates new tokens and adds them to minter\'s account balance');
			await contract.submitTransaction('Mint', '5000');
			console.log('*** Result: committed');
			...
			let test = await contract.evaluateTransaction('ClientAccountID');
			console.log(`*** Account_ID: ${test}`);
